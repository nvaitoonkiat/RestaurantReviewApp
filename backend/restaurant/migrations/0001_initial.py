# Generated by Django 2.1.7 on 2019-03-27 17:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fooddesc', models.CharField(blank=True, max_length=45, null=True)),
                ('vegetarian', models.CharField(max_length=3)),
                ('foodid', models.IntegerField(primary_key=True, serialize=False)),
                ('foodtype', models.CharField(blank=True, max_length=45, null=True)),
            ],
            options={
                'db_table': 'foods',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Foodtype',
            fields=[
                ('idfoodtype', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restname', models.CharField(blank=True, max_length=45, null=True)),
